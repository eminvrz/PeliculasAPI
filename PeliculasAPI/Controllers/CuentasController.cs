...
namespace PeliculasAPI.Controllers
{
    ...
    public class CuentasController : ControllerBase
    {
        ...
        [HttpPost("crear")]
        public async Task<ActionResult<RespuestaAutenticacionDTO>> Crear([FromBody] CredencialesUsuario credenciales)
        {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<RespuestaAutenticacionDTO>> Login([FromBody] CredencialesUsuario credenciales)
        {
        ...
        private async Task<RespuestaAutenticacionDTO> ConstruirToken(CredencialesUsuario credenciales)
        {
